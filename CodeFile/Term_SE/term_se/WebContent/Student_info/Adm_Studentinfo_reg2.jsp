...
<body>
	<h2> 학적 등록 </h2>
		...
		학번 : <input type="text" name="id" maxlength="20" value = "<%=id%>" disabled><br/>
		이름 : <input type="text" name="name" maxlength="40"><br/>
		전공 : <input type="text" name="major" maxlength="20" value = "<%=major%>"><br/>
		이미지 : <input type="text" name="image" maxlength="20"><br/>
		전화 번호 : <input type="text" name="phone" maxlength="20"><br/>
		주민등록 번호 : <input type="text" name="priv" maxlength="20" value = "<%=priv%>"><br/>
		주소 : <input type="text" name="addr" maxlength="10"><br/>
		입학 년도 : <input type="text" name="ent" maxlength="10" value = "<%=ent%>"><br/>
