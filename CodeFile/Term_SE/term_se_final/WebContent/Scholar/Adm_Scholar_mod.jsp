...
<body>
	<h2> 장학생 수정 </h2>
		<form method="post" action="Adm_Scholar_mod_pro.jsp">
		학번 : <input type="text" name="id" maxlength="20"required><br/>
		이름 : <input type="text" name="name" maxlength="40" required><br/>
		유형 : <input type="text" name="type" maxlength="20" required><br/>
		금액 : <input type="number" name="money" maxlength="10" required><br/>
