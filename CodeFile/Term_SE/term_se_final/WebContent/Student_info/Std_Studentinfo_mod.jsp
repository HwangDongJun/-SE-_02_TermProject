...
<body>
	...
	<form method="post" action="Std_Studentinfo_mod_pro.jsp">
		...
		이미지 : <input type="text" name="image" required  maxlength="20"><br/>
		전화 번호 : <input type="text" name="phone" required maxlength="20" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}"><br/>
		주소 : <input type="text" name="addr" required maxlength="10"><br/>
